...
class AddViewModelTest {
    ...
    fun addItemClickedTest() {
        //Given
        val expected = CHECKLIST_1.lines + listOf(ITEM_1)
        viewModel.lineItemText.postValue(ITEM_1.text)
    ...
    fun onDeleteClickedTest() {
        //Given
        val expected = listOf(ITEM_2)

        //When
        viewModel.onDeleteClicked(ITEM_1)
    ...
    fun moveItemTest() {
        //Given
        val expected = listOf(ITEM_2, ITEM_1)
